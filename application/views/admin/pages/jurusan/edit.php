    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card card-default">
            ...
            <form action="<?php echo site_url('jurusanController/edit/'.$jurusan->id_jurusan) ?>" method="post" enctype="multipart/form-data" >
            <input type="hidden" name="id" value="<?php echo $jurusan->id_jurusan?>" />
                <div class="form-group">
                    ...
                    <input class="form-control <?php echo form_error('nama_jurusan') ? 'is-invalid':'' ?>"
                        type="text" name="nama_jurusan" placeholder="Nama Jurusan" value="<?php echo $jurusan->nama_jurusan?>"/>
